...
def analyzeImageDataset(folderPath, resultFilePath):
    # 获取文件夹中的所有图像文件
    jpgFiles = glob.glob(os.path.join(folderPath, '*.jpg'))
...
if __name__ == "__main__":
    folderPath = r'../../data/raw/'  # 替换图像文件夹路径
    resultFilePath = '../../results/metrics/plots/image_analysis_results.csv'  # 结果文件路径
